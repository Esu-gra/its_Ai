...
print("***ESERCIZIO 1***")
# Legge il file CSV
df = pd.read_csv("SomeMusicAlbums(1).csv")

# Visualizza le prime 3 righe
print(df.head(3))
print("*****************"+"\n")    
...
## Soluzione:
print("***ESERCIZIO 4***")
df_after_1980 = df[df["Released"] > 1980][["Artist", "Album", "Released"]]
print(df_after_1980)
print("*****************"+"\n")
...
print("Media Rating:", media_rating)
print("*****************"+"\n")
...
print("durata massima:" , max_lenght)
min_lenght=df['Length'].min()
print("Durata minima:",min_lenght)
print("*****************"+"\n")
...
# Estrai tutti i generi, separa quelli combinati e rendili unici
generi_unici = (
    df["Genre"]
    .dropna()                    # rimuove valori NaN
    .str.lower()                 # uniforma il testo
    .str.split(",")              # divide i generi combinati
    .explode()                   # espande le liste in righe
    .str.strip()                 # rimuove spazi extra
    .unique()                    # prende i valori unici
)

# Stampa i generi unici
print(generi_unici)
...
### Soluzione:
print("***ESERCIZIO 8***")
difference=df["Sales_Difference"] = (df['Claimed Sales (millions)'] - df['Music Recording Sales (millions)']).abs()
print(difference)
print("*****************"+"\n") 
